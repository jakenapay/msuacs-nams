<div class="step2-container">
    <div class="form-container">
        ...
        <hr>
        <!-- <p><?= $this->session->userdata('reservation_otp'); ?></p> -->
        <?= form_open('form/reservation/verify_otp', array(
            'class' => 'px-5'
        )) ?>
        ...
        <!-- Resend OTP Button -->
        <div class="mt-3">
            <a href="<?= site_url('form/reservation/resend_otp') ?>" class="btn btn-secondary w-100">Resend OTP</a>
        </div>
    </div>
