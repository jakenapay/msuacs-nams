$(document).ready(function() {
    $('#departmentsTable').DataTable({
        ...
        ajax: {
            url: site_url + 'admin/configurations/departments/list', // Server-side data endpoint
            type: 'GET',
            dataType: 'json',
        ...
        buttons: [
            {
                ...
                title: 'Departments-CSV-' + getFormattedDate() 
            },
            {
                extend: 'excelHtml5',
                ...
                title: 'Departments-Excel-' + getFormattedDate()
            },
        ],
    });
    ...
    $('#departmentsTable').on('click', '.edit-btn', function() {
        ...
        $("#modal-edit").iziModal({
            ...
            subtitle: 'Edit Department Information',
        ...
        $.ajax({
            url: site_url + 'admin/configurations/departments/edit/view/' + id,
            type: 'GET',
...
/****************************DELETE FUNCTION**************************************** */    
    ...
    $('#departmentsTable').on('click', '.delete-btn', function(e) {
        e.preventDefault();
        var id = $(this).data("id");
        iziToast.question({
            message: "Delete Item?",
            ...
            buttons: [
                ["<button class=\"text-white\">Confirm</button>", function(instance, toast, button, e, inputs) {
                    $.ajax({
                        url: site_url + "admin/configurations/departments/delete/" + id,
                        type: "POST",
