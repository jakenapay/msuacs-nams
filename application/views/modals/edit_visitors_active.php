...
<?= form_open('admin/visit_management/visitors_active/update/' . $visitor['id'], ['id' => 'editVisitorForm']) ?>
<!-- <div class="row mb-2">
...
<div class="row mb-2">
    <div class="col-md-6 mb-2">
        ...
        <input class="form-control" name="rfid" id="rfid" type="text" value="<?= isset($visitor['rfid']) ? $visitor['rfid'] : '' ?>">
    </div>
</div>
