...
<?= form_open('admin/configurations/departments/edit/'. $department->id, ['id' => 'editDepartmentForm', 'enctype' => 'multipart/form-data']) ?>

<div class="row mb-2">
    <input class="form-control" name="id" id="id" type="number" value="<?= isset($department->id) ? $department->id : '' ?>" hidden>
    <div class="col-sm-3 mb-2">
        <label for="code">Department Code</label>
        <input class="form-control <?= form_error('code') ? 'form-error' : '' ?>" name="code" id="code" type="text" value="<?= isset($department->code) ? $department->code : set_value('code')?>" required> 
    </div>
