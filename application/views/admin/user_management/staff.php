        ...
        <div class="row">
            <div class="col-sm-12 dashboard-btn" id="add-row">
                    <a id="add-btn" class="btn btn-sm btn-icon-split mb-4 shadow-sm">
                        ...
                        <span class="text text-white d-none d-sm-block">Add New Staff</span>
                    </a>
        ...
        <div class="shadow mb-4 mt-2">
            <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-striped" id="staffsTable" width="100%" cellspacing="0"></table>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function(){
    ...
    $('#add-row').on('click', '#add-btn', function() {
        $.ajax({
            url: site_url + 'admin/user_management/staff/add/',
            type: 'GET',
    ...
    $("#modal-excel-import").iziModal({
        title: 'Import New Staff with Excel',
        subtitle: 'Add New Staff Record via Import',
        ...
        onOpening: function(modal){
            modal.startLoading();
            $.get(site_url + 'admin/user_management/staff/excel_import_form', function(data) {
    ...
    $("#modal-data-import").iziModal({
        ...
        subtitle: 'Import Staffs Data from SAIS',
        ...
        <div class="text-center mb-4">
            ...
            <h5>Are you sure you want to import staff data from SAIS?</h5>
            <p class="text-muted">This will sync the latest staff information.</p>
        </div>
    ...
    $(document).on('click', '#confirmDataImport', function () {
        $.ajax({
            url: site_url + 'api/getAllData/staff',
            type: 'GET',
            beforeSend: function () {
