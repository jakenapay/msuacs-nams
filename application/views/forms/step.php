                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="row-lg-12">
                            ...
                            <input type="text" name="id_type" class="form-control <?php echo (form_error('id_type') != '') ? 'is-invalid' : '' ?>" id="id_type" value="<?= set_value('id_type'); ?>">
                            <div class="invalid-feedback"><?php echo form_error('id_type'); ?></div>
                        </div>
                        <div class="row-lg-12">
                            <label for="id_number">ID Number</label>
                            <input type="text" name="id_number" class="form-control <?php echo (form_error('id_number') != '') ? 'is-invalid' : '' ?>" id="id_number" value="<?= set_value('id_number'); ?>">
                            <div class="invalid-feedback"><?php echo form_error('id_number'); ?></div>
                        </div>
                        <div class="row-lg-12">
                            <label for="company">Company</label>
                            <input type="text" name="company" class="form-control <?php echo (form_error('company') != '') ? 'is-invalid' : '' ?>" id="company" value="<?= set_value('company'); ?>">
                            <div class="invalid-feedback"><?php echo form_error('company'); ?></div>
                        </div>
                        <div class="row-lg-12">
                            <label for="purpose">Purpose of Visit</label>
                            <textarea name="purpose" class="form-control <?php echo (form_error('purpose') != '') ? 'is-invalid' : '' ?>" id="purpose" rows="3"><?= set_value('purpose'); ?></textarea>
                            <div class="invalid-feedback"><?php echo form_error('purpose'); ?></div>
                        </div>
                        <div class="row-lg-12">
                            <label for="host_name">Host Name</label>
                            <input type="text" name="host_name" class="form-control <?php echo (form_error('host_name') != '') ? 'is-invalid' : '' ?>" id="host_name" value="<?= set_value('host_name'); ?>">
                            <div class="invalid-feedback"><?php echo form_error('host_name'); ?></div>
                        </div>
                        <div class="row-lg-12">
                            <label for="visit_date">Visit Date and Time</label>
                            <input type="datetime-local" name="visit_date" class="form-control <?php echo (form_error('visit_date') != '') ? 'is-invalid' : '' ?>" id="visit_date" value="<?= set_value('visit_date'); ?>">
                            <div class="invalid-feedback"><?php echo form_error('visit_date'); ?></div>
                        </div>
                        <div class="row-lg-12">
                            <label for="visit_duration">Visit Duration</label>
                            <select name="visit_duration" class="form-control <?php echo (form_error('visit_duration') != '') ? 'is-invalid' : '' ?>" id="visit_duration">
                                <option value="1-hour" <?= set_select('visit_duration', '1-hour'); ?>>1 Hour</option>
                                <option value="2-hours" <?= set_select('visit_duration', '2-hours'); ?>>2 Hours</option>
                                <option value="half-day" <?= set_select('visit_duration', 'half-day'); ?>>Half Day</option>
                                <option value="full-day" <?= set_select('visit_duration', 'full-day'); ?>>Full Day</option>
                            </select>
