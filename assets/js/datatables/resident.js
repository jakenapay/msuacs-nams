$(document).ready(function () {
    ...
    $('#residentsTable').DataTable({
        ...
        ajax: {
            url: site_url + 'admin/user_management/residents/list',
            type: 'GET',
            dataType: 'json',
        },
        autoWidth: false,
        ...
        buttons: [
            {
                ...
                title: 'Residents_CSV-' + getFormattedDate()  // Add a custom file name for CSV
            },
            {
                extend: 'excelHtml5',
                ...
                title: 'Residents_Excel-' + getFormattedDate()  // Add a custom file name for Excel
            },
        ],
    ...
    $('#residentsTable').on('click', '.edit-btn', function () {
        var id = $(this).data('id');
        //Edit Modal Configurations
        $("#modal-edit").iziModal({
            title: 'Resident Information',
            icon: "fas fa-fw fa-user",
            subtitle: 'Edit Resident Information',
        ...
        $.ajax({
            url: site_url + 'admin/user_management/residents/view/' + id,
            type: 'GET',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (serverResponse.status == 200) {
                    ...
                    $('#residentsTable').DataTable().ajax.reload();
                }
                else {
    ...
    $('#residentsTable').on('click', '.delete-btn', function (e) {
        e.preventDefault();
        var id = $(this).data("id");
        iziToast.question({
            message: "Delete Item?",
            ...
            buttons: [
                ["<button class=\"text-white\">Confirm</button>", function (instance, toast, button, e, inputs) {
                    $.ajax({
                        url: site_url + "admin/user_management/residents/delete/" + id,
                        type: "POST",
    ...
    // Handle delete button click
    $('#residentsTable').on('click', '.ban-btn', function (e) {
        e.preventDefault();
        var id = $(this).data("id");
                    ...
                    iziToast.question({
                        ...
                        buttons: [
                            ["<button class=\"text-white\">Confirm</button>", function (instance, toast, button, e, inputs) {
                                ...
                                $.ajax({
                                    url: site_url + "admin/user_management/residents/ban/" + id,
                                    type: "POST",
                                    data: {
                                        id: id,
    ...
    // Handle delete button click
    $('#residentsTable').on('click', '.unban-btn', function (e) {
        e.preventDefault();
        var id = $(this).data("id");
                    ...
                    iziToast.question({
                            ...
                            [
                                `<select id="unban-locations" class="form-control text-white" multiple>
                                    ${(() => {
                                        ...
                                        $.ajax({
                                            url: site_url + 'admin/user_management/residents/getBannedLocations/' + id,
                                            type: 'GET',
                                            async: false,
                                            dataType: 'json',
                                            success: function(response) {
                        ...
                        buttons: [
                            ["<button class=\"text-white\">Confirm</button>", function (instance, toast, button, e, inputs) {
                                ...
                                $.ajax({
                                    url: site_url + "admin/user_management/residents/unban/" + id,
                                    type: "POST",
                                    data: {
                                        id: id,
                                        password: inputs[0].value,
