...
class FacultyModel extends CI_Model {
    ...
    public function banFaculty($id, $reason = null, $locations = null) {
    ...
    public function unbanFaculty($id, $reason = null, $locations = null) {
        $is_banned = empty($locations) ? 0 : 1;
        $locations = empty($locations) ? null : $locations;
    ...
    {
        return  $this->db->get_where('faculty', ['id' => $id])->row()->rfid;
    }

    public function getImage($id)
    {
        return  $this->db->get_where('faculty', ['id' => $id])->row()->image;
    }
