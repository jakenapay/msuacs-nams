...
<?= form_open('admin/user_management/faculty/add_faculty', ['id' => 'addFacultyForm', 'enctype' => 'multipart/form-data']) ?>
<div class="row mb-2">
...
<div class="row mb-2">
    ...
    <div class="col-sm-6 mb-2">
        ...
        <select class="form-control <?= form_error('department_id') ? 'form-error' : '' ?>" name="department_id" id="department">
...
<div class="row mb-2">
    ...
    <div class="col-sm-6 mb-2">
        ...
        <div class="input-group">
            ...
            <input type="number" name="emergency_contact_number" class="form-control" id="emergency_contact_number">
        </div>
    </div>
</div>
