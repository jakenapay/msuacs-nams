<?= form_open_multipart('admin/user_management/students/excel_import', ['id' => 'excelImportForm', 'class' => 'excelImport']); ?>
<div class="container">
...
<div class="container">
    ...
    <img src="<?= base_url('assets/images/SampleExcel.png') ?>" class="img-fluid rounded mb-5" alt="Excel sample format">
</div>
