...
<?= form_open('admin/user_management/students/add_student', ['id' => 'addStudentForm', 'enctype' => 'multipart/form-data']) ?>
<div class="row mb-2">
...
<div class="row mb-2">
    <div class="col-sm-6 mb-2">
        ...
        <select class="form-control <?= form_error('ccollege_idollege') ? 'form-error' : '' ?>" name="college_id" id="college">
...
<div class="row mb-2">
    <div class="col-sm-6 mb-2">
        ...
        <select class="form-control <?= form_error('program_id') ? 'form-error' : '' ?>" name="program_id" id="program">
            <option value="">Select Program</option>
        </select>
    </div>
    <div class="col-sm-6 mb-2">
        <label for="enrollment_status">Enrollment Status <span class="text-danger">*</span></label>
        <input type="text" name="enrollment_status" class="form-control" id="enrollment_status" value="<?= set_value('enrollment_status')?>" >
    </div>
</div>
