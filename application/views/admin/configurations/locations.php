        ...
        <div class="row">
            <div class="col-sm-12 dashboard-btn" id="add-row">
                    <a id="add-btn" class="btn btn-sm btn-icon-split mb-4 shadow-sm">
                        ...
                        <span class="text text-white d-none d-sm-block">Add New Location</span>
                    </a>
        ...
        <div class="shadow mb-4 mt-2">
            <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-striped" id="locationsTable" width="100%" cellspacing="0"></table>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function(){
    ...
    $('#add-row').on('click', '#add-btn', function() {
        $.ajax({
            url: site_url + 'admin/configurations/locations/add/view',
            type: 'GET',
