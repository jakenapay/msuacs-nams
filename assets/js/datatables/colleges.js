$(document).ready(function() {
    $('#collegesTable').DataTable({
        ...
        ajax: {
            url: site_url + 'admin/configurations/colleges/list', // Server-side data endpoint
            type: 'GET',
            dataType: 'json',
        ...
        buttons: [
            {
                ...
                title: 'Colleges-CSV-' + getFormattedDate() 
            },
            {
                extend: 'excelHtml5',
                ...
                title: 'Colleges-Excel-' + getFormattedDate()
            },
        ],
    });
    ...
    $('#collegesTable').on('click', '.edit-btn', function() {
        var id = $(this).data('id');
           //Edit Modal Configurations
        $("#modal-edit").iziModal({
            title: 'College Information',
            icon: "fas fa-fw fa-university",
            subtitle: 'Edit College Information',
        ...
        $.ajax({
            url: site_url + 'admin/configurations/colleges/edit/view/' + id,
            type: 'GET',
    ...
    $(document).on('submit', '#editCollegeForm', function(e) {
...
/****************************DELETE FUNCTION**************************************** */    
    ...
    $('#collegesTable').on('click', '.delete-btn', function(e) {
        e.preventDefault();
        var id = $(this).data("id");
        iziToast.question({
            message: "Delete Item?",
            ...
            buttons: [
                ["<button class=\"text-white\">Confirm</button>", function(instance, toast, button, e, inputs) {
                    $.ajax({
                        url: site_url + "admin/configurations/colleges/delete/" + id,
                        type: "POST",
