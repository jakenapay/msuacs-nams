$(document).ready(function() {
    ...
    $('#facultyTable').DataTable({
        ...
        ajax: {
            url: site_url + 'admin/user_management/faculty/list',
            type: 'GET',
            dataType: 'json',
        },
        autoWidth: false,
        ...
        buttons: [
            {
                ...
                title: 'Faculty_CSV-' + getFormattedDate()  // Add a custom file name for CSV
            },
            {
                extend: 'excelHtml5',
                ...
                title: 'Faculty_Excel-' + getFormattedDate()  // Add a custom file name for Excel
            },
        ],
...
/****************************IZIMODAL**************************************** */    
    ...
    $('#facultyTable').on('click', '.edit-btn', function() {
        ...
        $("#modal-edit").iziModal({
            ...
            subtitle: 'Edit Faculty Information',
        ...
        $.ajax({
            url: site_url + 'admin/user_management/faculty/view/' + id,
            type: 'GET',
    ...
    $(document).on('submit', '#editFacultyForm', function(e) {
        ...
        $.ajax({
            ...
            iziToast.error({
                title: 'Error',
                message: 'An error occurred while submitting the form: ' + xhr.responseText,
            });
            }
        });
    });
        ...
        iziToast.question({
            ...
            buttons: [
                ["<button class=\"text-white\">Confirm</button>", function(instance, toast, button, e, inputs) {
                    $.ajax({
                        url: site_url + "admin/user_management/faculty/delete/" + id,
                        type: "POST",
...
/****************************BAN FUNCTION**************************************** */    
    ...
    $('#facultyTable').on('click', '.ban-btn', function(e) {
        e.preventDefault();
        var id = $(this).data("id");
                    ...
                    iziToast.question({
                        ...
                        buttons: [
                            ["<button class=\"text-white\">Confirm</button>", function(instance, toast, button, e, inputs) {
                                ...
                                $.ajax({
                                    url: site_url + "admin/user_management/faculty/ban/" + id,
                                    type: "POST",
                                    data: {
                                        id: id,
    ...
    $('#facultyTable').on('click', '.unban-btn', function(e) {
        e.preventDefault();
        var id = $(this).data("id");
        $.ajax({
            url: site_url + 'admin/configurations/locations/list',
                    ...
                    iziToast.question({
                            ...
                            [
                                `<select id="unban-locations" class="form-control text-white" multiple>
                                    ${(() => {
                                        ...
                                        $.ajax({
                                            url: site_url + 'admin/user_management/faculty/getBannedLocations/' + id,
                                            type: 'GET',
                                            async: false,
                                            dataType: 'json',
                                            success: function(response) {
                        ...
                        buttons: [
                            ["<button class=\"text-white\">Confirm</button>", function(instance, toast, button, e, inputs) {
                                ...
                                $.ajax({
                                    url: site_url + "admin/user_management/faculty/unban/" + id,
                                    type: "POST",
                                    data: {
                                        id: id,
                                        password: inputs[0].value,
