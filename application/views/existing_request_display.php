<div class="step2-container">
    <div class="form-container">
        ...
        <div class="text-center review-title">
            <p>Reservation Status: <?= $visitor->status == 1 ? '<span class="bg-success p-2 rounded text-white">Pending</span>' : '<span class="bg-danger p-2 rounded text-white">Declined</span>'  ?></p>
        </div>
        ...
        <div class="row w-100 px-5 mb-5 mt-4">
            <div class="col-lg-12 col-xl-6">
                ...
                <input class="form-control <?php echo (form_error('first_name') != '') ? 'is-invalid' : '' ?>" name="first_name" id="first_name" type="text" value="<?= $visitor->first_name ?>">
                <div class="invalid-feedback"><?php echo form_error('first_name'); ?></div>
            </div>
            <div class="col-lg-12 col-xl-6"> 
                <label for="middle_name">Middle Name (Optional)</label>
                <input class="form-control <?php echo (form_error('middle_name') != '') ? 'is-invalid' : '' ?>" name="middle_name" id="middle_name" type="text" value="<?= $visitor->middle_name ?>">
                <div class="invalid-feedback"><?php echo form_error('middle_name'); ?></div>
            </div>
            <div class="col-lg-12 col-xl-6"> 
                <label for="suffix">Suffix (Optional)</label>
                <input class="form-control <?php echo (form_error('suffix') != '') ? 'is-invalid' : '' ?>" name="suffix" id="suffix" type="text" value="<?= $visitor->suffix ?>">
                <div class="invalid-feedback"><?php echo form_error('suffix'); ?></div>
            </div>
            <div class="col-lg-12 col-xl-6">
                <label for="last_name">Last Name <span class="text-danger">*</span></label>
                <input class="form-control <?php echo (form_error('last_name') != '') ? 'is-invalid' : '' ?>" name="last_name" id="last_name" type="text" value="<?= $visitor->last_name ?>">
            ...
            <div class="col-lg-12 col-xl-6">
                ...
                <div class="input-group">       
                    ...
                    <input placeholder="" type="text" name="phone_number" class="form-control <?php echo (form_error('phone_number') != '' || $this->session->flashdata('phone_number_error')) ? 'is-invalid' : '' ?>" id="phone_number" value="<?= $visitor->phone_number ?>" required onchange="formatPhoneNumber(this)">
                    <div class="invalid-feedback"><?php echo form_error('phone_number'); ?></div>
                </div>
            </div>
            <div class="col-lg-12 col-xl-6">
                <label for="email">Email <span class="text-danger">*</span></label>
                <input class="form-control <?php echo (form_error('email') != '') ? 'is-invalid' : '' ?>" name="email" id="email" type="text" value="<?= $visitor->email ?>">
        ...
        <div class="row w-100 px-5 mb-5 mt-4">
            <div class="col-lg-12 col-xl-6">
                ...
                <input type="text" name="company" class="form-control <?= (form_error('company')) ? 'is-invalid' : '' ?>" placeholder="Company (Optional)" value="<?= $visitor->company ?>">
            ...
            <div class="col-lg-12 col-xl-6 align-self-end id-fields">
                ...
                <input type="text" name="id_number" class="form-control <?= (form_error('id_number')) ? 'is-invalid' : '' ?>" placeholder="ID Number" value="<?= $visitor->id_number ?>">
                ...
                <label for="id_front">ID (Front) <span class="text-danger">*</span></label>
                    ...
                    <div class="form-file id-back">
                        <label for="id_front" class="id-label <?= (form_error('id_front_base64')) ? 'is-invalid' : '' ?>">Photo of Front ID
                            ...
                            <input type="hidden" name="id_front_base64" id="id_front_base64" value="<?= $visitor->id_front ?>">
                        </label>
            ...
            <div class="col-lg-12 col-xl-6 id-fields">
                <label for="id_back">ID (Back) <span class="text-danger">*</span></label>
                        ...
                        <label for="id_back" class="id-label <?= (form_error('id_back_base64')) ? 'is-invalid' : '' ?>">Photo of ID (back)
                            ...
                            <input type="hidden" name="id_back_base64" id="id_back_base64" value="<?= $visitor->id_back ?>">
                        </label>
        ...
        <div class="row w-100 px-5 mt-4">
            <div class="col-lg-12 col-xl-6">
                ...
                <input type="text" name="visit_purpose" class="form-control <?= (form_error('visit_purpose')) ? 'is-invalid' : '' ?>" placeholder="" value="<?= $visitor->visit_purpose ?>">
            ...
            <div class="col-lg-12 col-xl-6">
                ...
                <select class="form-control" id="contact_department" name="contact_department">
                    ...
                    <?php foreach($departments as $department): ?>
                        <option value="<?= $department->name ?>" <?= set_select('contact_department', $department->name, isset($visitor->contact_department) && $visitor->contact_department == $department->name); ?> ><?= $department->name ?></option>
                    <?php endforeach; ?>
                </select>
                ...
                <input class="form-control <?php echo (form_error('emergency_contact_person') != '') ? 'is-invalid' : '' ?>" name="emergency_contact_person" id="emergency_contact_person" type="text" value="<?= isset($visitor->emergency_contact_person) ? $visitor->emergency_contact_person : '' ?>">
        ...
        <div class="d-flex justify-content-around">
                <button type="submit" class="mt-5" onclick="displayLoader()"><span id="loader" class="spinner-border spinner-border-sm" style="display: none;"></span> Update</button>
